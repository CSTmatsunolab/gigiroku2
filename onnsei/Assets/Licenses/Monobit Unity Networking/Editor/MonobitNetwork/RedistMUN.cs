...
namespace MonobitEngine
{
    public class RedistMUN : AssetPostprocessor
    {
        ...
        enum MonobitEngineLibraryType
        {
            ...
            MonobitEngineLibraryType_for_WinARM32     = 0x0D,
            MonobitEngineLibraryType_for_WinARM64     = 0x0E,
            MonobitEngineLibraryType_for_Win          = 0x0F,
            MonobitEngineLibraryType_for_WSA          = 0x10,
        ...
        static readonly Dictionary<string, MonobitEngineLibraryType> MonobitEngineLibraryList = new Dictionary<string, MonobitEngineLibraryType>()
        {
            ...
            { "Assets/Plugins/arm/mrs.dll",                          MonobitEngineLibraryType.MonobitEngineLibraryType_for_WinARM32     },
            { "Assets/Plugins/arm/opus.dll",                         MonobitEngineLibraryType.MonobitEngineLibraryType_for_WinARM32     },
            { "Assets/Plugins/arm64/mrs.dll",                        MonobitEngineLibraryType.MonobitEngineLibraryType_for_WinARM64     },
            { "Assets/Plugins/arm64/opus.dll",                       MonobitEngineLibraryType.MonobitEngineLibraryType_for_WinARM64     },
            ...
            foreach (KeyValuePair<string, MonobitEngineLibraryType> kvp in MonobitEngineLibraryList)
            {
                ...
                switch (kvp.Value)
                {
...
#else
                            SettingPlatform(plugin, false, null, "");
#endif
                        }
                        break;
                    ...
                    case MonobitEngineLibraryType.MonobitEngineLibraryType_for_Win64:
                        ...
                        break;
                    case MonobitEngineLibraryType.MonobitEngineLibraryType_for_WinARM32:
                        {
                            // Windows ARM 32bit
                            SettingPlatform(plugin, false, new BuildTarget[] { BuildTarget.WSAPlayer }, "ARM");
                        }
                        break;
                    case MonobitEngineLibraryType.MonobitEngineLibraryType_for_WinARM64:
                        {
                            // Windows ARM 64bit
                            SettingPlatform(plugin, false, new BuildTarget[] { BuildTarget.WSAPlayer }, "ARM64");
                        }
                        break;
                        ...
                        case BuildTarget.WSAPlayer:
                            {
                                ...
                                {
                                    plugin.SetPlatformData(BuildTarget.WSAPlayer, "CPU", "ARM");
                                }
                                else if (cpuType == "ARM64")
                                {
                                    plugin.SetPlatformData(BuildTarget.WSAPlayer, "CPU", "ARM64");
                                }
                                else
                                {
